...
const ruleCodeLabels: Record<string, string> = {
  ...
  'apply-leech-seed': '附加寄生种子',
  'apply-taunt': '附加挑衅',
  'apply-torment': '附加招式限制',
  'attack-stat-double': '攻击翻倍',
  binding: '束缚',
  'break-target-protection-damage': '破除保护伤害',
  'charge-skip-once': '跳过一次蓄力',
  'choice-speed-lock': '提升速度并锁定招式',
  'clear-all-active-stat-stages': '清除双方能力阶级',
  'clear-field-hazards-and-substitutes': '清除全场陷阱与替身',
  'clear-target-side-barriers-and-field-hazards': '清除目标侧屏障与全场陷阱',
  'clear-user-side-hazards-and-traps': '清除己方陷阱与束缚',
  'consumable-full-hp-fatal-damage-survival': '满体力承受致命伤害并消耗',
  'contact-based-skill-damage-boost': '强化接触类招式',
  'contact-damage-to-attacker-eighth': '接触后反伤八分之一',
  'contact-damage-to-attacker-sixth': '接触后反伤六分之一',
  'contact-paralysis': '接触后麻痹攻击方',
  'contact-side-effect-immunity': '免疫接触副作用',
  'contact-skill-protection-bypass': '接触招式绕过保护',
  'contact-transfer-to-attacker': '接触后转移给攻击方',
  ...
  'first-skill-action-only-damage': '上场首行动限定伤害',
  ...
  'heal-block': '回复封锁',
  'held-end-turn-damage-eighth': '回合末损失八分之一体力',
  ...
  'maximize-user-attack-half-max-hp-cost': '支付半数最大 HP 并最大化攻击',
  'no-damage': '无伤害',
  'proportional-damage': '比例伤害',
  'protect-hit': '受保护判定',
  'protect-self': '保护自身',
  'endure-fatal-damage': '挺住保留 HP',
  'punch-based-contact-suppression': '拳击类招式不接触',
  'punch-based-skill-power-boost': '强化拳击类招式威力',
  ...
  'self-major-status-cure': '清除自身主要异常',
  ...
  'target-pending-damaging-skill-damage': '目标待攻击伤害',
  'target-pending-priority-damaging-skill-damage': '目标待先制度攻击伤害',
  ...
  torment: '招式限制',
  'average-user-target-current-hp': '平均使用者与目标当前 HP',
  'user-current-hp-sacrifice-damage': '造成使用者当前体力等量伤害并倒下',
  'user-side-active': '己方当前上场成员',
  'user-side-multi-target-skill-protection': '一侧范围技能防护',
  'user-side-priority-skill-protection': '一侧先制度技能防护',
...
export const abilityPolicyOptions = makeRuleCodeOptions([
  ...
  'contact-damage-to-attacker-eighth',
  ...
  'contact-skill-protection-bypass',
...
export const itemPolicyOptions = makeRuleCodeOptions([
  ...
  'contact-damage-to-attacker-sixth',
  'contact-transfer-to-attacker',
  'held-end-turn-damage-eighth',
  'punch-based-skill-power-boost',
  'punch-based-contact-suppression',
  'contact-side-effect-immunity',
  'charge-skip-once',
