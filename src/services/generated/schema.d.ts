...
export interface paths {
  ...
  '/api/player/trainer-session/heartbeat': {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
  ...
  '/api/player/matches/{matchId}/turns': {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
  ...
  '/api/player/matches/{matchId}/forfeit': {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
  ...
  '/api/player/trainers/{trainerId}/match-history/{matchId}': {
    ...
    get: operations['matchHistoryDetail'];
    put?: never;
    post?: never;
    delete?: never;
    options?: never;
  ...
  '/api/player/matches/history/{matchId}': {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
...
export interface components {
  schemas: {
    ...
    SubmitMatchTurnRequest: {
      submissionId?: string;
      /** Format: int64 */
      expectedRevision?: number;
      actions?: components['schemas']['MatchTurnAction'][];
    };
    ...
    MatchTurnResponse: {
      locked: boolean;
      match?: components['schemas']['MatchViewResponse'] | null;
    };
...
export interface operations {
  ...
  submitTurn: {
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['SubmitMatchTurnRequest'];
      };
    };
    responses: {
      /** @description OK */
      200: {
        ...
        content: {
          '*/*': components['schemas']['MatchTurnResponse'];
        };
      };
    };
  };
  ...
  accept: {
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['AcceptChallengeRequest'];
      };
    };
    responses: {
      /** @description Match 已启动 */
      200: {
        headers: {
          [name: string]: unknown;
        };
      ...
      503: {
        ...
        content: {
          'application/json': components['schemas']['ChallengeErrorResponse'];
        };
      };
    };
  };
  ...
  matchHistory: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          '*/*': components['schemas']['MatchHistoryResponse'][];
        };
      };
    };
  };
  ...
  find: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          '*/*': components['schemas']['PublicTrainerProfile'];
        };
      };
