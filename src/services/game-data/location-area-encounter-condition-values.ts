...
const RESOURCE_PATH = '/api/game-data/location-area-encounter-condition-values' as const;
 ...
 */
export function createLocationAreaEncounterConditionValuesGameDataService(
